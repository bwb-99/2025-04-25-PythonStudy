...
'''
    ...
    파이썬
      ...
      4) 기본 문법
       ...
       5. 집합 자료형-가장 많이 등장-
       리스트형 : 중복 데이터 허용,
       튜플형 : 데이터베이스 , 중복 허용, 한번 값을 지정되면 변경 할 수 없다.
       셀형 : 중복데이터 허용(X) => Set => {}
       딕트형 : Map => 키, 값 => ["키","값"]
               웹 => JSON 전송
       변수 : 변경이 가능한 값
       ...
       2. 연산자
          정수/정수 = 실수
          ** // 제곱근
          bool => True/False (true/false=오류)
'''
#변수 => 출력
a = 10
print(a)
print(type(a)) # 데이터형 type
print(id(a)) # 메모리 주소값을 확인 id(변수명)
b = 10.5
print(b)
print(type(b))
c = True
...
n = 20
#end = "\n"
print(f"m={m}",end=" ") # print,  end=" " : 옆으로 출력
print(f"n={n}") # println
print("m:%d" %m, "n:%d" %n , sep="-") #sep=" " : 기호 출력
# 구분자 sep
# 출력물 / end / sep