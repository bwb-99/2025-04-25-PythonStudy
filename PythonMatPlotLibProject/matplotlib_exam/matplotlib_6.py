"""
  ...
  BackEnd : Java , Python , JSP ,
            ThymeLeaf , Numpy , Pandas , Matplotlib , MyBatis JPA
  FrontEnd : HTML5,JavaScript(ES6)
            Jquery , Ajax , VueJs , Vuex , Pinia , React , React-Query , Redux , Next , NodeJS
...
import json
client_id = "va6zZp1mHlBGS6tIO2He"
client_secret = "KR6setBTQ8"
fd=input("검색어 입력:")
