...
#C:\springDev\2024-03-17-SpringStudy\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\SpringLastProject/img/emp.png
def empGraphData(request):
    ...
    emp.plot.scatter(x='ename',y="sal",
                    s=300,c='red')
    #plt.show()
    plt.savefig(f"C:/springDev/2024-03-17-SpringStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SpringLastProject/img/emp{no}.png")
